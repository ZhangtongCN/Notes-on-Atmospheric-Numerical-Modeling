# Notes-on-Atmospheric-Numerical-Modeling
# NUIST 大气数值模式 学习笔记
NUIST 大气数值模式 学习笔记  包含课程：《数值天气预报》、《大气模式及数值模拟》
<p>声明：
本项目仅为个人学习笔记的汇编。笔记中的文本内容遵循 CC BY-NC-SA 4.0 协议。项目中引用的图片、课件截图、图表等素材，其版权归原作者所有，若有侵权请提交issue删除。
本项目仅供学习交流与参考，严禁用于非正当用途！</p>
